		...
		<section className='container'>
			<div className='w-full relative w850:hidden'>
				<div className='absolute p-4 pl-px top-[80px] left-[-1px] rounded-tr-2xl rounded-br-2xl bg-background'>
					...
					<div className='flex items-center gap-6 w1150:gap-4 w1150:top-[105px]'>
						<StatisticsWrapper title='23' subTitle='Пункт выдачи по Кыргызстану' />
						<StatisticsWrapper title='7' subTitle='Областей' />
						<StatisticsWrapper title='10 000+' subTitle='Выданных посылок ежемесячно' />
					</div>
			...
			<div className='hidden w850:block pt-4'>
				<div className='flex justify-between items-center gap-2'>
					<h4 className='sectionTitle text-primary_text'>Пункты выдачи заказов</h4>
				...
				<div className='grid gap-4 grid-cols-2 pt-4 b-green-400 w550:gap-3 w420:grid-cols-1 w370:gap-2'>
					<StatisticsWrapper
						title='23'
						subTitle='Пункт выдачи по Кыргызстану'
						textCenter={true}
						wFull={true}
					/>
					<StatisticsWrapper title='7' subTitle='Областей' textCenter={true} wFull={true} />
				</div>
				<div className='flex flex-col gap-4 pt-4 w550:gap-3 w550:pt-3'>
					<StatisticsWrapper
						title='10 000+'
						subTitle='Выданных посылок ежемесячно'
						textCenter={true}
						wFull={true}
					/>
				</div>
