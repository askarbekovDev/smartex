...
export const DropDownMenu: FC<DropDownMenuProps> = ({ menuOpen, setMenuOpen }) => {
	...
	return (
		<>
			<Backdrop isOpen={menuOpen} setIsOpen={setMenuOpen} moveDown={true} />
			<div
        ...
        w450:-translate-x-1/2 w450:left-1/2`,
					{
			...
			>
				<div className='hidden w450:block rounded-bl-2xl absolute h-full bg-white top-0 w-[22px] left-[-21px] w370:w-[18px] w370:left-[-17px]' />
				<div className='hidden w450:block rounded-br-2xl absolute h-full bg-white top-0 w-[22px] right-[-21px] w370:w-[18px] w370:right-[-17px]' />
				<div
