	...
	return (
		<nav className='flex items-center gap-5 uiNavLink w1350:gap-3 w1150:hidden'>
			...
			<span className='flex gap-5 uiBtnText w1350:gap-3'>
				<Link className='text-white px-4 py-2 rounded-2xl bg-success hover:bg-(--success-hover) transition-all duration-200' href='#'>
					Войти
				</Link>
				<Link className='px-4 py-2 rounded-2xl border-[1px] bg-background border-success hover:bg-(--background-hover)' href='#'>
					Регистрация
				</Link>
			</span>
		</nav>
